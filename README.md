...
*Reflection*
The most challenging part was ensuring the model handled missing and categorical data correctly. 
With more time, hyperparameter tuning and feature engineering could improve prediction accuracy.
